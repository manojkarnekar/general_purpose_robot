...
def generate_launch_description():
    ...
    p_robot_description_pkg = get_package_share_directory('v2_p_robot_description')
    ...
    declare_rviz_config_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            p_robot_description_pkg, 'rviz', 'mir_visu_full.rviz'),
    ...
    launch_gazebo_world = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'world': [p_robot_description_pkg, '/worlds/', LaunchConfiguration('world'), '.world']
        }.items()
    )
    ...
    '''launch_mir_description = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(p_robot_description_pkg, 'launch', 'mir_launch.py')
        )
    )'''
    ...
    #     [
    #         "xacro ", 
    #         os.path.join(p_robot_description_pkg, "urdf", "mir.urdf.xacro")
    #     ]
    #     ),
    #     value_type=str
    # )
    ...
    robot_description = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("v2_p_robot_description"), "urdf", "p_robot.urdf.xacro"]
            ),
        ]
    )
    ...
    launch_v2_p_robot_description = Node(
    ...
    ld.add_action(launch_v2_p_robot_description)
